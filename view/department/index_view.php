...
<!-- dung de xem cai list department -->
<div class="row">
    <div class="col-sm-12 col-md-12">
        <a class="btn btn-primary btn-sm" href="index.php?c=department&m=add">Add New Department</a>
        <div class="row mt-3">
            ...
            <tbody>
                ...
                <?php foreach ($departments as $key => $item) : ?>
                    <tr>
                        ...
                        <td><?= $item['name']; ?></td>
                        <td width="10%">
                            <img style="width:80px; height:80px;" class="img-fluid" alt="<?= $item['name']; ?>" src="public/uploads/images/<?= $item['logo']; ?>">
                        </td>
                        <td><?= $item['leader']; ?></td>
